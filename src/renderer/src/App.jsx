...
import rightArrow from './assets/arrow-pointing-right.svg'
...
function App() {
  ...
  const continueArrow = async () => {
    setCurrentScene(scene.LOGIN)
  }
    ...
    <>
      {currentScene === scene.CHOOSE_SCHOOL && (
        <>
          ...
          <div className="text react">Select a PDF Below</div>
          ...
          ></FileSubmissionBox>
          <img alt="continue" className="arrow" src={rightArrow} onClick={continueArrow} />
        </>
      )}
    </>
    //     {currentScene === scene.CHOOSE_SCHOOL && (
